    ...
    <body>
        ...
        <div class="padding searchBar">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                    <form class="form-inline" id="search-topics">
                        <?php 
                            $q = htmlspecialchars($_GET['q']);
                            echo '<input class="form-control my-1 ml-auto mr-2" type="search" type="search" name="q" placeholder="Search" aria-label="Search" id="search" value="' . $q . '">'; 
                        ?>
                        <button class="btn btn-light" name="search_btn">Search</button><button class="btn btn-danger ml-2 mr-auto" name="reset" type="reset">Reset</button>
                    </form>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="padding aboutSec searchSection">
                <div>
